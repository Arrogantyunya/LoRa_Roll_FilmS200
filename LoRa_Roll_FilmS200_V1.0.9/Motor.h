...
#define OTHER_MOTOR_PIN       PC5 //S200，有两个电机，这是另一个电机的控制引脚（本来是接蜂鸣器的）
#define OTHER_MOTOR_EN        (digitalWrite(OTHER_MOTOR_PIN, LOW))
#define OTHER_MOTOR_DIS       (digitalWrite(OTHER_MOTOR_PIN, HIGH))
...
/*卷膜超时时间*/
#define ROLL_OVERTIME         2000 //(s)  1S 0.5cm,2000就是10米

/*ADC分辨率*/
#define V_RESOLUTION          (3.3 / 4096 * 1000)

#define DETECT_START_ROLL_TIME          5

#define CURRENT_COLLECTION_FREQ         4

#define REALTIME_OPEN_FREQ              5

#define MAX_OPENING_TIME                2000

#define OPENING_THRESHOLD               10

#define REVERSING_DELAY                 3000

#define MOTOR_START_DELAY               2000
...
extern volatile bool A_Flag;  
extern volatile bool B_Flag;  
...
extern volatile bool gJumpRunResetRollFlag;
extern volatile bool gJumpRunOpeningFlag;
extern volatile bool gJumpRunFroceOpenFlag;
extern volatile bool gForceOpenToForceOpenFlag;
extern volatile unsigned char gJumpNextOpening;
...
public:
  ...
  void Jump_Motor_Action_Handler(void);
